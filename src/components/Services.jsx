      ...
      <div className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="grid gap-px overflow-hidden rounded-sm border border-ink-line/70 bg-ink-line/70 sm:grid-cols-2">
          {SERVICES.map((service) => (
            <article key={service.mark} className="bg-ink-deep p-8">
              <span className="grid h-9 w-9 place-items-center rounded-full border border-blue-line font-mono text-sm text-blue-bright">
                {service.mark}
              </span>
