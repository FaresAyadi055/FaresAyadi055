  ...
  return (
    ...
    >
      <iframe
        ...
        sandbox="allow-scripts -allow-same-origin -notification -location -allow-popups -allow-top-navigation -allow-modals -allow-pointer-lock -allow-forms -allow-downloads"
